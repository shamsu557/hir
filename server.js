...
function initializeSuperAdmin() {
    const checkSuperAdminQuery = 'SELECT COUNT(*) as count FROM h_admins WHERE role = "SuperAdmin"';
    db.query(checkSuperAdminQuery, (err, results) => {
        ...
        if (superAdminCount === 0) {
            ...
            const insertQuery = 'INSERT INTO h_admins (username, password, name, phone, security_question, security_answer, role, first_login) VALUES (?, ?, ?, ?, ?, ?, ?, TRUE)';
...
app.post('/api/update-admin-credentials', async (req, res) => {
    ...
    const checkQuery = 'SELECT * FROM h_admins WHERE username = ? AND username != ?';
    db.query(checkQuery, [trimmedUsername, username.trim()], (err, results) => {
        ...
        const updateQuery = 'UPDATE h_admins SET username = ?, password = ?, name = ?, phone = ?, security_question = ?, security_answer = ?, first_login = FALSE WHERE username = ?';
...
app.post('/api/create-admin', async (req, res) => {
    ...
    const checkQuery = 'SELECT * FROM h_admins WHERE username = ?';
...
app.get('/api/admins', (req, res) => {
    ...
    const query = 'SELECT id, username, name, phone, role, security_question, security_answer FROM h_admins';
...
app.get('/api/admins/:id', (req, res) => {
    ...
    const query = 'SELECT id, username, name, phone, role, security_question, security_answer FROM h_admins WHERE id = ?';
...
app.put('/api/admins/:id', async (req, res) => {
    ...
    const checkQuery = 'SELECT * FROM h_admins WHERE username = ? AND id != ?';
    db.query(checkQuery, [trimmedUsername, adminId], async (err, results) => {
        ...
        let updateQuery = 'UPDATE h_admins SET username = ?, name = ?, phone = ?, role = ?, security_question = ?, security_answer = ?';
...
app.delete('/api/admins/:id', (req, res) => {
    ...
    const adminId = req.params.id;
    const checkQuery = 'SELECT role FROM h_admins WHERE id = ?';
    db.query(checkQuery, [adminId], (err, results) => {
        ...
        const deleteQuery = 'DELETE FROM h_admins WHERE id = ?';
...
app.post('/api/change-password', async (req, res) => {
    ...
    const query = 'SELECT security_answer FROM h_admins WHERE username = ?';
    db.query(query, [trimmedUsername], (err, results) => {
        ...
        const updateQuery = 'UPDATE h_admins SET password = ?, first_login = FALSE WHERE username = ?';
...
app.get('/api/user-details', (req, res) => {
    ...
    const query = 'SELECT username, name, role, first_login FROM h_admins WHERE username = ?';
...
app.post('/api/forgot-password/verify-username', (req, res) => {
    ...
    const query = 'SELECT security_question FROM h_admins WHERE username = ?';
...
app.post('/api/forgot-password/reset-password', async (req, res) => {
    ...
    try {
        const hashedPassword = await bcrypt.hash(newPassword, 10);
        const query = 'UPDATE h_admins SET password = ?, first_login = FALSE WHERE username = ?';
